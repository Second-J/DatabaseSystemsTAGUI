    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            while(rs.next()){
                ...
                if(username.equals(jTextField1.getText()) && password.equals(jTextField2.getText())){
                    new MovieList().setVisible(true);
                    MovieList.currentUser = username;
                    this.dispose();
                    ae = true;
                }
            }
            if(!ae){
                JOptionPane.showMessageDialog(null, "Usename/Password incorrect");
            }
